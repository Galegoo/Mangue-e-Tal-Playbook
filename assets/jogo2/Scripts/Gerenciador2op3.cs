...
public class Gerenciador2op3 : MonoBehaviour {
    ...
    void Spawn()
    {
        copia0 = Instantiate((animais[3]), posicoes[0].transform.position, posicoes[0].transform.rotation) as GameObject;
        copia1 = Instantiate((animais[8]), posicoes[1].transform.position, posicoes[1].transform.rotation) as GameObject;
        copia2 = Instantiate((animais[1]), posicoes[2].transform.position, posicoes[2].transform.rotation) as GameObject;
        copia3 = Instantiate((animais[5]), posicoes[3].transform.position, posicoes[3].transform.rotation) as GameObject;
        copia4 = Instantiate((animais[6]), posicoes[4].transform.position, posicoes[4].transform.rotation) as GameObject;
        copia5 = Instantiate((animais[7]), posicoes[5].transform.position, posicoes[5].transform.rotation) as GameObject;
        ...
        copia8 = Instantiate((animais[2]), posicoes[8].transform.position, posicoes[6].transform.rotation) as GameObject;
        copia9 = Instantiate((animais[4]), posicoes[9].transform.position, posicoes[7].transform.rotation) as GameObject;
    }
